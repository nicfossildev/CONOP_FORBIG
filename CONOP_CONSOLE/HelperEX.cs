    ...
    public static partial class Helper
    {
        ...
        Label7000:
            if (COMMOD9.STKF == 7)
            {
                ...
                {
                    COMMOD9.TSPEN = COMMOD9.TSPEN + COMMOD9.NEGATIVE[I, COMMOD9.NSCT + 3] - COMMOD9.NEGATIVE[I, COMMOD9.NSCT + 2];
                }
            }
...
//cpms  fix JRANK within limits
        ...
        public static void NEWPEN(int IRNK, int JRNK, int[] HPERM, ref double HPEN)
        {
            ...
            // TODO : for sum of HPEN, if COMMOD9.CRTPEN is bigger, quited
            for (int i = 0; i< COMMOD9.NSCT; i++)
            {
                HPEN += COMMOD9.COLPEN[i];
